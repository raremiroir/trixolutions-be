<script>
   ...
   // Color of button
   // == primary | secondary | error | success | info | warning | transparent | transparent-alt
   // + outlined version (= outlined prop to true)
...
<button 
   ...
   class="
     ...
     { square  ? 'rounded-none' : rounded ? 'rounded-full'
