...
<script lang="ts">
	// Import components
   import { Div, Link, Article, Tag } from "$comp";
   ...
   // If card is link, enter url and aria-label
   export let link = '';
   ...
   let outerWrapComp = article ? Article : Div;
   // If link isnt specified, make div
   let wrapComp = link ? Link : Div;
         ...
         <div class="
            ...
            <div class="
               ...
               <div class="
                  ...
                  {#if label}
                     <Tag primary={labelPrimary} small={labelSm} large={labelLg}>
                        {label}
                     </Tag>
                  {/if}
               </div>
